...
README lead-ins, list items, and commands are fragments. The automated `landing and README sentences use plain words` test checks the same 22-word and banned-word rules.
...
| Machine-readable file | `proof.json` |
| Human-readable file | HTML report or `report.html` |
