...
Polish derivatives (2026-08-28): `social-card.jpg` is a centered 1200×630 crop of the project-owned hero art. `apple-touch-icon.png` is a centered 180×180 crop of the same art. Both were made locally with ImageMagick; no new third-party source was introduced.
